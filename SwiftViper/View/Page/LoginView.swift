    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            Button(action: {
                ...
                loginPresenter.loginButtonTapped(userParam: UserParam(username: "emilys", password: "emilyspass"))
                }) {
...
//        LoginView()
        LoginView(loginPresenter: AuthPresenter(loginInteractor: AuthInteractor(productRepository: ProductRepository(netWorkManager: NetWorkManager())), authManager: AuthenticationManager()))
    }
}
